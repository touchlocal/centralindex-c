...
char * doCurl (char * method, char * path, char * params) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  char * postAgency( char *agency_id, char *country, char *name, char *description, char *active) {
    CURL *curl = curl_easy_init();
    char params[10000];
    char *p;
    strcpy(params,"?api_key=");
    strcat(params,API_KEY);
    strcat(params,"?");
    strcat(params,"agency_id=");
    p = curl_easy_escape(curl,agency_id,0);
    strcat(params,p);
    curl_free(p);
    strcat(params,"&");
    strcat(params,"country=");
  ...
  */
   ...
   *  @return - the data from the api
  */
  char * deleteAgency( char *agency_id) {
    CURL *curl = curl_easy_init();
    char params[10000];
    char *p;
    strcpy(params,"?api_key=");
  ...
  */
   ...
   *  @return - the data from the api
  */
  char * getContract_logSuccess_by_date( char *date, char *success) {
    CURL *curl = curl_easy_init();
    char params[10000];
    char *p;
    strcpy(params,"?api_key=");
  ...
  */
   ...
   *  @return - the data from the api
  */
  char * postEntityAgency( char *entity_id, char *agency_id) {
    CURL *curl = curl_easy_init();
    char params[10000];
    char *p;
    strcpy(params,"?api_key=");
   ...
   *  @return - the data from the api
  */
  char * deleteEntityAgency( char *entity_id, char *gen_id) {
    CURL *curl = curl_easy_init();
    char params[10000];
    char *p;
    strcpy(params,"?api_key=");
  ...
  */
   ...
   *  @return - the data from the api
  */
  char * getEntityBy_agencyid( char *agency_id) {
    CURL *curl = curl_easy_init();
    char params[10000];
    char *p;
    strcpy(params,"?api_key=");
  ...
  */
   ...
   *  @return - the data from the api
  */
  char * postProduct( char *product_id, char *name, char *strapline, char *price, char *currency, char *active, char *billing_period) {
    CURL *curl = curl_easy_init();
    char params[10000];
    char *p;
    strcpy(params,"?api_key=");
  ...
  */
   ...
   *  @return - the data from the api
  */
  char * postSyndicationRenew( char *syndication_type, char *publisher_id, char *entity_id, char *group_id, char *seed_masheryid, char *supplier_masheryid, char *country, char *reseller_masheryid, char *expiry_date) {
    CURL *curl = curl_easy_init();
    char params[10000];
    char *p;
    strcpy(params,"?api_key=");
  ...
  */
   ...
   *  @return - the data from the api
  */
  char * getToolsSyndicateEnablemedia( char *entity_id, char *reseller_masheryid, char *destructive) {
    CURL *curl = curl_easy_init();
    char params[10000];
    char *p;
    strcpy(params,"?api_key=");
  ...
  */
   ...
   *  @return - the data from the api
  */
  char * postUser( char *email, char *user_id, char *first_name, char *last_name, char *active, char *trust, char *creation_date, char *user_type, char *social_network, char *social_network_id, char *reseller_admin_masheryid, char *group_id, char *admin_upgrader, char *agency_id) {
    CURL *curl = curl_easy_init();
    char params[10000];
    char *p;
    strcpy(params,"?api_key=");
