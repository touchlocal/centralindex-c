...
char * doCurl (char * method, char * path, char * params) {
  ...
  */
   ...
   *  @return - the data from the api
  */
  char * postGroupBulk_update( char *group_id, char *user_id, char *data) {
    CURL *curl = curl_easy_init();
    char params[10000];
    char *p;
    strcpy(params,"?api_key=");
