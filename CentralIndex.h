...
void set_debug_mode (int debug);
  ...
  */
   ...
   *  @return - the data from the api
  */
  char * getToolsDbvtsv( char *entity_id);
  ...
  */
   ...
   *  @return - the data from the api
  */
  char * getToolsGooglexml( char *entity_id);
  ...
  */
   ...
   *  @return - the data from the api
  */
  char * getToolsTomtomxml( char *entity_id);
